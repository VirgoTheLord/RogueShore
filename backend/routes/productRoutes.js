...
productRouter.post("/", protect, admin, async (req, res) => {
  try {
    ...
    const product = new Product({
      ...
      weight,
      sku,
      user: req.user._id, //id of admin user creating product
    });
...
//retrieve product with highest rating
//public access
...
//retrieve new arrivals (latest products) based on createdAt date
//public access
...
//retrieve similar products based on category and gender
